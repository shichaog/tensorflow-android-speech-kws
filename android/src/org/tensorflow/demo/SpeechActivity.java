...
public class SpeechActivity extends Activity {
  ...
  public SpeechActivity() throws IOException {
  }
          ...
          new Runnable() {
            ...
            public void run() {
              ...
              if (!result.foundCommand.startsWith("_") && result.isNewCommand) {
                ...
                Log.e(LOG_TAG,"+++++++++++labelIndex:"+ labelIndex);
               if(labelIndex ==2){
                  try {
                    AssetFileDescriptor afd = getAssets().openFd("active.wav");
                    mPlayer.reset();
                    mPlayer.setDataSource(afd.getFileDescriptor(), afd.getStartOffset(), afd.getLength());
                    mPlayer.prepare();
                    mPlayer.setVolume(0.90f , 0.90f);
                    mPlayer.start();
                  }catch(IOException e){
                    e.printStackTrace();
                  }
